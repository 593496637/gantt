      ...
      <template v-else>
        ...
        >
          <el-table-column
            ...
            width="300"
          >
            <el-table-column prop="province" label="白班" width="120">
              <template slot-scope="scope">
                <div :class="dayGanttType(scope.row, t.full_date)">
                  <div
                    class="ratio-box"
                    v-if="dayGanttType(scope.row, t.full_date) && scope.row.day"
                  >
                    <span
                      v-for="(item, index) in scope.row.day"
                      :key="index"
                      class="order"
            ...
            <el-table-column prop="city" label="晚班" width="120">
              <template slot-scope="scope">
      ...
      if (week) {
        ...
        for (let i = 1; i < dates_num; i++) {
          days.push({
            ...
            name: `${i}日`,
            id: uuidv4(),
            full_date: `${year}-${month < 10 ? "0" + month : month}-${
              i < 10 ? "0" + i : i
            }`,
          });
        }
